                                        ...
                                        <?php foreach ($candidat->documents as $document) : ?>
                                            <div class="document-item mb-2">
                                                <a href="#" class="document-link" 
                                                   ...
                                                   data-bs-target="#documentModal<?= htmlspecialchars($document['doc_nomDocument']); ?>">
                                                    <?= htmlspecialchars($document['doc_descriptionDocument']); ?>
                                                </a>

                                                <!-- Modal pour l'image -->
                                                <div class="modal fade" id="documentModal<?= htmlspecialchars($document['doc_nomDocument']); ?>" tabindex="-1" aria-labelledby="documentModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="documentModalLabel"><?= htmlspecialchars($document['doc_descriptionDocument']); ?></h5>
